...
##acf plot of residuals to check the independence of the error terms, making sure there is no correlation between the error terms.
## Blue lines represent the significant correlation threshold.
